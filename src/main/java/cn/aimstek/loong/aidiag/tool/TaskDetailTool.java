...
public class TaskDetailTool {
    ...
    public String getTaskDetail(@ToolParam(description = "WCS任务ID或WMS任务号") String taskId) {
        ...
        try {
            ...
            node.put("wmsTaskNo", detail.getWmsTaskNo());
            node.put("taskSource", detail.getTaskSource());
            node.put("businessType", detail.getBusinessType());
            node.put("taskType", detail.getTaskType());
            node.put("taskState", detail.getTaskState());
            node.put("handleState", detail.getHandleState());
            node.put("containerCode", detail.getContainerCode());
            node.put("businessFrom", detail.getBusinessFrom());
            node.put("definiteFrom", detail.getDefiniteFrom());
            node.put("businessTo", detail.getBusinessTo());
            node.put("definiteTo", detail.getDefiniteTo());
            ...
            node.put("definiteTime", str(detail.getDefiniteTime()));
